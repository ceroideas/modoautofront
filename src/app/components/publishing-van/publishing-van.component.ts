...
@Component({
  selector: 'app-publishing-van',
  templateUrl: './publishing-van.component.html',
  styleUrls: ['./publishing-van.component.scss']
})
export class PublishingVanComponent implements OnInit {
  ...
  getAdverts()
  {
    this.api.getAdverts('Furgonetas').subscribe((data:any)=>{
      this.data = data[0];
